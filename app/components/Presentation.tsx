      ...
      <div className="max-w-4xl mx-auto w-full">
          ...
          {lang === "fr" ? (
            <>
              <p className="text-[#f1f5f9] text-lg leading-relaxed mb-8">
                Je m'appelle <span className="text-[#fbbf24] font-semibold">Khalil Moughamir</span>, j'ai{" "}
                <span className="text-[#fbbf24] font-semibold">20 ans</span> et je suis étudiant en 2ème année
            ...
            <>
              <p className="text-[#f1f5f9] text-lg leading-relaxed mb-8">
                My name is <span className="text-[#fbbf24] font-semibold">Khalil Moughamir</span>, I am{" "}
                <span className="text-[#fbbf24] font-semibold">20 years old</span> and a 2nd year student in the
              ...
              <p className="text-[#94a3b8] text-base leading-relaxed">
                ...
                <span className="text-[#fbbf24] font-semibold">data analysis applied to football</span>.
        ...
        >
          ...
          >
            ...
            <span className="block text-[#f1f5f9] font-bold text-sm uppercase tracking-wide group-hover:text-[#fbbf24] transition-colors duration-200">
              {lang === "fr"
                ...
                : "Discover my high-level sports journey"}
            </span>
          </Link>
          ...
          >
            ...
            <span className="block text-[#f1f5f9] font-bold text-sm uppercase tracking-wide group-hover:text-[#fbbf24] transition-colors duration-200">
              {lang === "fr" ? "Mes centres d'intérêt" : "My interests"}
            </span>
          </Link>
        </motion.div>
