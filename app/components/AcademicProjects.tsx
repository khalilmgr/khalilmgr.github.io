...
const projects = {
  ...
  en: [
    {
      title: "Paris 2024 Olympics Data Analysis with Power BI",
      description:
        "Interactive dashboard built with Power BI to analyze athlete performances, events, and key statistics from the 2024 Olympic Games using dynamic visualizations.",
      github: "https://github.com/khalilmgr/olympics-data-analysis",
    },
    {
      title: "CoLive – Co-living Platform for Student Interns",
      description:
        "Web application allowing student interns to more easily find shared housing or list accommodations, simplifying access to housing during their studies.",
      github: "https://github.com/khalilmgr/colive-symfony-app",
    },
    {
      title: "Peg Solitaire Game Developed in Python",
      description:
        "Python implementation of the Peg Solitaire puzzle game with grid management, move validation, and complete game logic.",
      github: "https://github.com/khalilmgr/peg-solitaire-python",
    },
    {
      title: "Video Game Catalog – Steam-Inspired Web Application",
      description:
        "Web application allowing users to browse a video game catalog with detailed game pages and easy navigation to explore different titles.",
      github: "https://github.com/khalilmgr/video-game-library-php",
    },
    {
      title: "Maze Generation Algorithms in Python",
      description:
        "Python project implementing multiple maze generation algorithms (DFS, Sidewinder, Binary Tree, Wilson, Kruskal) to create and analyze perfect mazes.",
      github: "https://github.com/khalilmgr/maze-generation-algorithms",
    },
  ] as Project[],
};
    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-6 py-24 bg-[#0f172a]">
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {list.map((p, i) => (
            <ProjectCard key={p.github + i} project={p} index={i} lang={lang} />
          ))}
        </div>
      </div>
    </section>
