      ...
      <div className="relative z-10 text-center max-w-lg mx-auto w-full">
        ...
        <div className="flex flex-col items-center gap-6">
          <motion.a
            ...
            whileTap={{ scale: 0.97 }}
            className="inline-flex items-center gap-2.5 px-6 py-3.5 bg-[#1e5f8c] text-white font-mono text-sm sm:text-base font-semibold rounded-full hover:bg-[#1c2f4a] transition-colors duration-200"
          >
            <EmailIcon />
